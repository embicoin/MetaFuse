...
1. Even if you delete files, these are NOT deleted from MetaDisk. Don't delete too many files, or MetaDisk will be a MetaGarbage. I don't know how to delete files from MetaDisk. Please inform me if you know.
